...
TEST_CASE("Grid Interpolation", "[sasktran2][grids]") {
    sasktran2::grids::outofbounds o =
        GENERATE(sasktran2::grids::outofbounds::extend,
                 sasktran2::grids::outofbounds::setzero);
    sasktran2::grids::gridspacing s =
        GENERATE(sasktran2::grids::gridspacing::constant,
    ...
    sasktran2::grids::Grid grid = sasktran2::grids::Grid(
        std::move(copy_grid), s, o, sasktran2::grids::interpolation::linear);
