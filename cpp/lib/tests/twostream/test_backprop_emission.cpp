...
void construct_atmo_geometry_emission(
...
TEST_CASE("Backprop_OpticalDepth_emission", "[twostream][backprop]") {
    std::unique_ptr<sasktran2::atmosphere::Atmosphere<1>> atmo;
    std::unique_ptr<sasktran_disco::GeometryLayerArray<1>> layer_geo;

    construct_atmo_geometry_emission(atmo, layer_geo);

    int natmo = atmo->storage().total_extinction.rows();

    Eigen::RowVectorXd grad(5 * natmo);
    grad.setZero();
    ...
    sasktran2::twostream::Input<sasktran2::twostream::SourceType::ONLY_THERMAL>
        input;
...
TEST_CASE("Backprop_thermalb0_emission", "[twostream][backprop]") {
    std::unique_ptr<sasktran2::atmosphere::Atmosphere<1>> atmo;
    std::unique_ptr<sasktran_disco::GeometryLayerArray<1>> layer_geo;
...
TEST_CASE("Backprop_thermalb1_emission", "[twostream][backprop]") {
    std::unique_ptr<sasktran2::atmosphere::Atmosphere<1>> atmo;
    std::unique_ptr<sasktran_disco::GeometryLayerArray<1>> layer_geo;
    ...
    for (int i = 0; i < natmo - 1; i++) {
        REQUIRE(abs(grad_map.d_thermal_b1(i) - numerical_grad(i)) < 1e-6);
    }
}

TEST_CASE("Backprop_SSA_emission", "[twostream][backprop]") {
    std::unique_ptr<sasktran2::atmosphere::Atmosphere<1>> atmo;
    std::unique_ptr<sasktran_disco::GeometryLayerArray<1>> layer_geo;
...
TEST_CASE("Backprop_Homog_emission", "[twostream][backprop]") {
    std::unique_ptr<sasktran2::atmosphere::Atmosphere<1>> atmo;
    std::unique_ptr<sasktran_disco::GeometryLayerArray<1>> layer_geo;
    ...
    std::array<Eigen::RowVectorXd, 1> weights;
    weights[0] = Eigen::RowVectorXd::Random(natmo - 1);

    std::array<Eigen::RowVectorXd, 1> weights_Xp;
    weights_Xp[0] = Eigen::RowVectorXd::Random(natmo - 1);

    std::array<Eigen::RowVectorXd, 1> weights_Xm;
    weights_Xm[0] = Eigen::RowVectorXd::Random(natmo - 1);

    std::array<Eigen::RowVectorXd, 1> weights_omega;
...
TEST_CASE("Backprop_Particular_emission", "[twostream][backprop]") {
    std::unique_ptr<sasktran2::atmosphere::Atmosphere<1>> atmo;
    std::unique_ptr<sasktran_disco::GeometryLayerArray<1>> layer_geo;
    ...
    // Let our output quantity be random weights * homog.k and Xplus/Xminus
    std::array<Eigen::RowVectorXd, 1> weights_Gplus_top;
    weights_Gplus_top[0] = Eigen::RowVectorXd::Random(natmo - 1) +
                           Eigen::RowVectorXd::Ones(natmo - 1);

    std::array<Eigen::RowVectorXd, 1> weights_Gplus_bottom;
    weights_Gplus_bottom[0] = Eigen::RowVectorXd::Random(natmo - 1);

    std::array<Eigen::RowVectorXd, 1> weights_Gminus_top;
    weights_Gminus_top[0] = Eigen::RowVectorXd::Random(natmo - 1);

    std::array<Eigen::RowVectorXd, 1> weights_Gminus_bottom;
    ...
    for (int i = 0; i < natmo - 1; i++) {
        REQUIRE(abs(grad_map.d_thermal_b0(i) - numerical_grad(i)) < 1e-4);
    }
}

TEST_CASE("Backprop_BVP_emission", "[twostream][backprop]") {
    std::unique_ptr<sasktran2::atmosphere::Atmosphere<1>> atmo;
    std::unique_ptr<sasktran_disco::GeometryLayerArray<1>> layer_geo;
    ...
    // Let our output quantity be random weights * homog.k and Xplus/Xminus
    std::array<Eigen::MatrixXd, 1> weights;
...
TEST_CASE("Backprop_Full_emission", "[twostream][backprop]") {
    ...
    std::array<Eigen::MatrixXd, 1> bvp_storage;
...
TEST_CASE("Backprop_Particular_ext_emission", "[twostream][backprop]") {
    std::unique_ptr<sasktran2::atmosphere::Atmosphere<1>> atmo;
    std::unique_ptr<sasktran_disco::GeometryLayerArray<1>> layer_geo;

    construct_atmo_geometry_emission(atmo, layer_geo, 0.01);
...
TEST_CASE("Backprop_BVP_ext_emission", "[twostream][backprop]") {
    std::unique_ptr<sasktran2::atmosphere::Atmosphere<1>> atmo;
    std::unique_ptr<sasktran_disco::GeometryLayerArray<1>> layer_geo;
...
TEST_CASE("Backprop_Full_ext_emission", "[twostream][backprop]") {
    std::unique_ptr<sasktran2::atmosphere::Atmosphere<1>> atmo;
    std::unique_ptr<sasktran_disco::GeometryLayerArray<1>> layer_geo;
...
TEST_CASE("Backprop_Full_b1_emission", "[twostream][backprop]") {
    std::unique_ptr<sasktran2::atmosphere::Atmosphere<1>> atmo;
    std::unique_ptr<sasktran_disco::GeometryLayerArray<1>> layer_geo;
    ...
    Eigen::RowVectorXd grad(natmo * 5);
    grad.setZero();
...
TEST_CASE("Backprop_Particular_b1_emission", "[twostream][backprop]") {
    std::unique_ptr<sasktran2::atmosphere::Atmosphere<1>> atmo;
    std::unique_ptr<sasktran_disco::GeometryLayerArray<1>> layer_geo;
...
TEST_CASE("Backprop_BVP_b1_emission", "[twostream][backprop]") {
    std::unique_ptr<sasktran2::atmosphere::Atmosphere<1>> atmo;
    std::unique_ptr<sasktran_disco::GeometryLayerArray<1>> layer_geo;
