/**
 * @file atmosphere.h
 * @brief Functions and types for managing atmospheric storage in radiative transfer.
 *
 ...
 */
  ...
  *
  * An AtmosphereStorage object contains all of the optical data necessary to perform
  * the radiative transfer calculation at the given grid points.  Typically this is
  * things like single scatter albedo, extinction, legendre coefficients at a set of
  ...
  *
  * A DerivativeMapping object is the input quantities necessary to map derivatives calculated
  * by the model internally (with respect to SSA, total_extinction, scattering quantities) to
  ...
  *
  * An atmosphere object is all of the geometry independent information required to perform
  * the radiative transfer calculation.  This is a combination of an AtmosphereStorage object
  * that contains layer/grid quantities, and a Surface object.
  */
  ...
  *
  * The surface object contains information of the Earth's surface, including the BRDF
  ...
  */
 AtmosphereStorage* sk_atmosphere_storage_create(int nlocation, int nwavel, int nphase_moments,
