...
namespace sasktran2::mie {
    ...
    struct MieOutput {
        ...
        std::complex<double> refractive_index;  /** copy of the input refractive index */
        Eigen::VectorXd cos_angles;             /** copy of the input cos angles */

        MieData values;                         /** Mie values */
        MieData d_by_size_param;                /** Derivative of Mie values by the size parameter */
        MieData d_by_refrac_real;               /** Derivative of Mie values by the real part of the refractive index */
        MieData d_by_refrac_imag;               /** Derivative of Mie values by the imaginary part of the refractive index */
    };
    ...
    class MieBase {
        private:
            ...
            virtual void internal_calculate(const Eigen::VectorXd& size_param,
        ...
        public:
             ...
             * @param calculate_derivative set to true to also calculate derivatives of size parameter and refractive index
            ...
            const MieOutput& calculate(const Eigen::VectorXd& size_param,
                ...
                internal_calculate(size_param, refractive_index, cos_angles, calculate_derivative, m_output);
                return m_output;
                }
    };
}
