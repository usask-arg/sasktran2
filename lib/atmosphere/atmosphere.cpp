...
namespace sasktran2::atmosphere {
    ...
    Atmosphere<NSTOKES>::Atmosphere(const std::vector<Constituent> &constituents,
                                    Surface &&surface,
    ...
    m_storage(wavelengths.size(), geometry.size(), config.num_singlescatter_moments())
    {
    ...
    Atmosphere<NSTOKES>::Atmosphere(int nwavel, const sasktran2::Geometry1D &geometry, const sasktran2::Config &config,
                                    bool calculate_derivatives) :
                                    m_storage(nwavel, geometry.size(), config.num_singlescatter_moments()),
                                    m_calculate_derivatives(calculate_derivatives)
                                    {
