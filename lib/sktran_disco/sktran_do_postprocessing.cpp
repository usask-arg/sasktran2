...
namespace sasktran_disco::postprocessing {
    ...
    template void h_plus_sampled<-1>(
        const sasktran_disco::LayerDual<double>& thickness,
    ...
    template void
    h_plus_sampled<1>(const sasktran_disco::LayerDual<double>& thickness,
                      const sasktran_disco::VectorLayerDual<double, 1>& eigval,
                      sasktran_disco::SolutionIndex solution_index,
                      double layer_relative_location,
                      sasktran_disco::LayerDual<double>& h_plus);
    ...
    template void
    h_plus_sampled<2>(const sasktran_disco::LayerDual<double>& thickness,
    ...
    template void
    h_plus_sampled<8>(const sasktran_disco::LayerDual<double>& thickness,
    ...
    template void
    h_plus_sampled<3>(const sasktran_disco::LayerDual<double>& thickness,
    ...
    template void
    h_plus_sampled<6>(const sasktran_disco::LayerDual<double>& thickness,
                      const sasktran_disco::VectorLayerDual<double, 6>& eigval,
                      sasktran_disco::SolutionIndex solution_index,
                      double layer_relative_location,
                      sasktran_disco::LayerDual<double>& h_plus);

    template void h_plus_sampled<24>(
        const sasktran_disco::LayerDual<double>& thickness,
    ...
    template void h_minus_sampled<-1>(
        const sasktran_disco::LayerDual<double>& thickness,
        const sasktran_disco::VectorLayerDual<double, -1>& eigval,
        sasktran_disco::SolutionIndex solution_index,
        double layer_relative_location,
    ...
    template void
    h_minus_sampled<1>(const sasktran_disco::LayerDual<double>& thickness,
                       const sasktran_disco::VectorLayerDual<double, 1>& eigval,
                       sasktran_disco::SolutionIndex solution_index,
                       double layer_relative_location,
                       sasktran_disco::LayerDual<double>& h_minus);
    ...
    template void
    h_minus_sampled<2>(const sasktran_disco::LayerDual<double>& thickness,
                       const sasktran_disco::VectorLayerDual<double, 2>& eigval,
                       sasktran_disco::SolutionIndex solution_index,
                       double layer_relative_location,
                       sasktran_disco::LayerDual<double>& h_minus);
    ...
    template void
    h_minus_sampled<8>(const sasktran_disco::LayerDual<double>& thickness,
                       const sasktran_disco::VectorLayerDual<double, 8>& eigval,
                       sasktran_disco::SolutionIndex solution_index,
                       double layer_relative_location,
                       sasktran_disco::LayerDual<double>& h_minus);
    ...
    template void
    h_minus_sampled<3>(const sasktran_disco::LayerDual<double>& thickness,
                       const sasktran_disco::VectorLayerDual<double, 3>& eigval,
                       sasktran_disco::SolutionIndex solution_index,
                       double layer_relative_location,
                       sasktran_disco::LayerDual<double>& h_minus);
    ...
    template void
    h_minus_sampled<6>(const sasktran_disco::LayerDual<double>& thickness,
                       const sasktran_disco::VectorLayerDual<double, 6>& eigval,
                       sasktran_disco::SolutionIndex solution_index,
                       double layer_relative_location,
                       sasktran_disco::LayerDual<double>& h_minus);

    template void h_minus_sampled<24>(
        const sasktran_disco::LayerDual<double>& thickness,
        const sasktran_disco::VectorLayerDual<double, 24>& eigval,
        sasktran_disco::SolutionIndex solution_index,
        double layer_relative_location,
    ...
    template void d_minus_sampled<-1>(
        const sasktran_disco::LayerDual<double>& thickness,
        const sasktran_disco::VectorLayerDual<double, -1>& eigval,
        sasktran_disco::SolutionIndex solution_index,
        double layer_relative_location,
    ...
    template void
    d_minus_sampled<1>(const sasktran_disco::LayerDual<double>& thickness,
                       const sasktran_disco::VectorLayerDual<double, 1>& eigval,
                       sasktran_disco::SolutionIndex solution_index,
                       double layer_relative_location,
                       const sasktran_disco::Dual<double>& transmission,
    ...
    template void
    d_minus_sampled<2>(const sasktran_disco::LayerDual<double>& thickness,
                       const sasktran_disco::VectorLayerDual<double, 2>& eigval,
                       sasktran_disco::SolutionIndex solution_index,
                       double layer_relative_location,
                       const sasktran_disco::Dual<double>& transmission,
    ...
    template void
    d_minus_sampled<8>(const sasktran_disco::LayerDual<double>& thickness,
                       const sasktran_disco::VectorLayerDual<double, 8>& eigval,
                       sasktran_disco::SolutionIndex solution_index,
                       double layer_relative_location,
                       const sasktran_disco::Dual<double>& transmission,
    ...
    template void
    d_minus_sampled<3>(const sasktran_disco::LayerDual<double>& thickness,
                       const sasktran_disco::VectorLayerDual<double, 3>& eigval,
                       sasktran_disco::SolutionIndex solution_index,
                       double layer_relative_location,
                       const sasktran_disco::Dual<double>& transmission,
    ...
    template void
    d_minus_sampled<6>(const sasktran_disco::LayerDual<double>& thickness,
                       const sasktran_disco::VectorLayerDual<double, 6>& eigval,
                       sasktran_disco::SolutionIndex solution_index,
                       double layer_relative_location,
                       const sasktran_disco::Dual<double>& transmission,
    ...
    template void d_minus_sampled<24>(
        const sasktran_disco::LayerDual<double>& thickness,
        const sasktran_disco::VectorLayerDual<double, 24>& eigval,
        sasktran_disco::SolutionIndex solution_index,
        double layer_relative_location,
    ...
    template void d_plus_sampled<-1>(
        const sasktran_disco::LayerDual<double>& thickness,
        const sasktran_disco::VectorLayerDual<double, -1>& eigval,
        sasktran_disco::SolutionIndex solution_index,
        double layer_relative_location,
    ...
    template void
    d_plus_sampled<1>(const sasktran_disco::LayerDual<double>& thickness,
                      const sasktran_disco::VectorLayerDual<double, 1>& eigval,
                      sasktran_disco::SolutionIndex solution_index,
                      double layer_relative_location,
                      const sasktran_disco::Dual<double>& transmission,
    ...
    template void
    d_plus_sampled<2>(const sasktran_disco::LayerDual<double>& thickness,
                      const sasktran_disco::VectorLayerDual<double, 2>& eigval,
                      sasktran_disco::SolutionIndex solution_index,
                      double layer_relative_location,
                      const sasktran_disco::Dual<double>& transmission,
    ...
    template void
    d_plus_sampled<8>(const sasktran_disco::LayerDual<double>& thickness,
                      const sasktran_disco::VectorLayerDual<double, 8>& eigval,
                      sasktran_disco::SolutionIndex solution_index,
                      double layer_relative_location,
                      const sasktran_disco::Dual<double>& transmission,
    ...
    template void
    d_plus_sampled<3>(const sasktran_disco::LayerDual<double>& thickness,
                      const sasktran_disco::VectorLayerDual<double, 3>& eigval,
                      sasktran_disco::SolutionIndex solution_index,
                      double layer_relative_location,
                      const sasktran_disco::Dual<double>& transmission,
    ...
    template void
    d_plus_sampled<6>(const sasktran_disco::LayerDual<double>& thickness,
                      const sasktran_disco::VectorLayerDual<double, 6>& eigval,
                      sasktran_disco::SolutionIndex solution_index,
                      double layer_relative_location,
                      const sasktran_disco::Dual<double>& transmission,
    ...
    template void d_plus_sampled<24>(
        const sasktran_disco::LayerDual<double>& thickness,
        const sasktran_disco::VectorLayerDual<double, 24>& eigval,
        sasktran_disco::SolutionIndex solution_index,
        double layer_relative_location,
