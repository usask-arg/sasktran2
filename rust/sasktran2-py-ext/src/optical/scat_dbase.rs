...
#[pyclass]
pub struct PyScatteringDatabaseDim4 {
...
impl PyScatteringDatabaseDim4 {
    ...
    #[allow(clippy::too_many_arguments)]
    pub fn new(
        xsec: PyReadonlyArray4<f64>,
        ssa: PyReadonlyArray4<f64>,
        legendre: PyReadonlyArray5<f64>,
        wvnum: PyReadonlyArray1<f64>,
        param0: PyReadonlyArray1<f64>,
        param1: PyReadonlyArray1<f64>,
        param2: PyReadonlyArray1<f64>,
        param_names: Vec<String>,
    ) -> Self {
        let xsec = xsec.as_array();
        let ssa = ssa.as_array();
        ...
        let param0 = param0.as_array().to_owned();
        let param1 = param1.as_array().to_owned();
        let param2 = param2.as_array().to_owned();
