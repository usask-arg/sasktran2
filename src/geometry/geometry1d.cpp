...
namespace sasktran2 {
    ...
    Geometry1D::Geometry1D(double cos_sza, double saa, double earth_radius, Eigen::VectorXd &&grid_values,
                           sasktran2::grids::interpolation interp_method, geometrytype geotype) :
                           Geometry(Coordinates(cos_sza, saa, earth_radius, geotype, true)),
                           m_alt_grid(std::move(grid_values), sasktran2::grids::gridspacing::automatic, sasktran2::grids::outofbounds::extend, interp_method)
                           {
