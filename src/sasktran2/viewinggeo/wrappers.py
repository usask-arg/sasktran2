...
class TangentAltitudeSolar:
    ...
    def __init__(self, tangent_altitude_m: float, relative_azimuth: float, observer_altitude_m: float, cos_sza: float):
        """
...
class GroundViewingSolar:
    ...
    def __init__(self, cos_sza: float, relative_azimuth: float, cos_viewing_zenith: float, observer_altitude_m: float):
        """
